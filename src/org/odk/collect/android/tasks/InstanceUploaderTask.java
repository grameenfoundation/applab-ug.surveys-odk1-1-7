...
public class InstanceUploaderTask extends AsyncTask<Long, Integer, HashMap<String, String>> {
    ...
    protected HashMap<String, String> doInBackground(Long... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            //selection = selection = InstanceColumns.INTERVIEWEE;
            Log.d("VALUE"+i, values[i].toString());
        ...
        if (c.getCount() > 0) {
            ...
            next_submission: while (c.moveToNext()) {
                ...
                for (int i =0; i < c.getColumnCount(); i ++) {
                	...
                	//Log.d("VALUE", c.getString(i));
                }
                String id = c.getString(c.getColumnIndex(InstanceColumns._ID)); 
                String intervieweeId = c.getString(c.getColumnIndex(InstanceColumns.INTERVIEWEE));
                String location = c.getString(c.getColumnIndex(InstanceColumns.LOCATION));
                ...
                if (uriRemap.containsKey(u)) {
                    ...
                    openRosaServer = true;
                    u = uriRemap.get(u);
                    Log.d("SERVER", "OpenRosa Server");
                    Log.d("U", u.getPath());
                } else {
                	Log.d("SERVER", "Other Server");
                ...
                while (j < files.size() || first) {
                 ...
                 // Configure connection
                    ...
                    // Setup client
                    DefaultHttpClient httpclient2 = new DefaultHttpClient(params);
                    Log.d("URL", "url="+url);
